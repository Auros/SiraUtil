...
namespace SiraUtil.Objects.Beatmap
{
    ...
    /// </summary>
    public sealed class ProModeNoteRegistration : TemplateRedecoratorRegistration<GameNoteController, BeatmapObjectsInstaller>
    {
        /// <summary>
        ...
        public ProModeNoteRegistration(Func<GameNoteController, GameNoteController> redecorateCall, int priority = 0, bool chain = true) : base("_proModeNotePrefab", redecorateCall, priority, chain) { }
    }
}