...
namespace SiraUtil.Tools.FPFC
{
    ...
    internal class CameraController : MonoBehaviour
    {
        ...
        [Inject]
        [UsedImplicitly]
        private void Construct(IFPFCManager fpfcManager, List<IFPFCListener> fpfcListeners, [InjectOptional] IMenuControllerAccessor? menuControllerAccessor)
        {
        ...
        private void Deactivate()
        {
            ...
            if (!_fpfcManager!.LockViewOnDisable)
            {
                if (_cameraData != null)
                {
                    _cameraData.allowXRRendering = true;
                }
